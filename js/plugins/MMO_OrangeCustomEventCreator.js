 ...
 *=============================================================================*/
 ...
 (function($) {
  ...
  function createNormalEventAt(characterName, characterIndex, x, y, d, scriptOrCommonEventId, temporary, _pages, uniqueId, selectedPage, customList, customTrigger, forcedPriority = 0) {
    ...
    if (customTrigger) eventData.page.trigger = customTrigger;
    if (_pages && _pages[0]) {
    ...
    if (customList) Object.assign(eventData.page.list, customList);
    ...
    if (_pages && _pages.length) {
      ...
      for (let i = 0; i < _pages.length; i++) {
        ...
        eventData.pages[i].priorityType = forcedPriority || _pages[i].priorityType;
